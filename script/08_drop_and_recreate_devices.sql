-- =====================================================
-- Script 08 FIX: Drop e Ricrea Tabella Devices
-- =====================================================
-- Descrizione: Droppa la vecchia tabella devices e la ricrea
--              con la struttura completa per gestire gli orologi GPS
--
-- ⚠️ ATTENZIONE: Questo script CANCELLA tutti i dati nella tabella devices!
-- =====================================================

-- Drop tabella devices (CASCADE per eliminare anche foreign keys)
DROP TABLE IF EXISTS devices CASCADE;

-- Ricrea tabella devices con struttura completa
...
CREATE INDEX idx_devices_internal_id ON devices(device_internal_id);
...
DO $$
BEGIN
    RAISE NOTICE '✓ Tabella devices droppata e ricreata con successo!';
    ...
    RAISE NOTICE '⚠️  ATTENZIONE: Tutti i dati precedenti sono stati cancellati!';
END $$;
